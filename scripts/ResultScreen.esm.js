...
const RESULT_SCREEN_UESR_POINTS_ID = "js-user-points";
...
class ResultScreen extends Common {
    ...
    bindToElements() {
        ...
        this.userPointsElement = this.bindToElement(
            RESULT_SCREEN_UESR_POINTS_ID
        );

        this.highScoreElement = this.bindToElement(
            RESULT_SCREEN_HIGH_SCORES_ID
        );
